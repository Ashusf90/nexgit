...
## v0.1.0 - Contributor Readiness

Goal: prove the architecture and contribution model with a maintainer-owned foundation first, then atomic contributor tasks.
...
- Maintainers have visible dependency, protocol, and planning decisions.
- The first implementation issues require no hidden architecture decisions.
