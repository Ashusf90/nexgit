...
Dependencies should make Contributor Readiness easier to build without locking Nexgit into a heavy architecture too early.
...
Contributor Readiness direction:
